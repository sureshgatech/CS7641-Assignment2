...
fourPeaksDF = pd.read_csv(os.path.join('data', 'GA_countones.csv'))
...
fig.savefig(os.path.join('image', 'GA_countones_iter.png'))

#fitness v. fevals
plt.clf()
sns_plot2=sns.lineplot(x="fevals", y="fitness", data=fourPeaksDF,)
fig2=sns_plot2.get_figure()
fig2.savefig(os.path.join('image', 'GA_countones_fevals.png'))
...
fig3.savefig(os.path.join('image', 'GA_countones_feval_iters.png'))