...
OUTFILE = 'E:\CS7641\Assignment2\SureshCode\data\NN_BACKPROP.csv'
...
def main():
    ...
    train(BatchBackPropagationTrainer(data_set,classification_network,measure,rule), classification_network, 'Backprop', training_ints,validation_ints,testing_ints, measure, TRAINING_ITERATIONS)
