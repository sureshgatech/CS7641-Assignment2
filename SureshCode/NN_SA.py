...
OUTFILE  = 'E:\CS7641\Assignment2\SureshCode\data\NN_XXX_SA.csv'
...
def main(CE):
    ...
    train(oa, classification_network, oa_name, training_ints,validation_ints,testing_ints, measure,TRAINING_ITERATIONS)
