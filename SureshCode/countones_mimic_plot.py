...
fourPeaksDF = pd.read_csv(os.path.join('data', 'MIMIC_countones.csv'))
...
fig.savefig(os.path.join('image', 'MIMIC_countones_iter.png'))

#fitness v. fevals
plt.clf()
sns_plot2=sns.lineplot(x="fevals", y="fitness", data=fourPeaksDF,)
fig2=sns_plot2.get_figure()
fig2.savefig(os.path.join('image', 'MIMIC_countones_fevals.png'))
...
fig3.savefig(os.path.join('image', 'MIMIC_countones_feval_iters.png'))